...
class AffineLayer(LayerWithParameters):
    ...
    def fprop(self, inputs):
        ...
        """
<<<<<<< HEAD
        return inputs @ self.weights.T + self.biases.T
=======
...
>>>>>>> upstream/mlp2022-23/lab3
    ...
    def grads_wrt_params(self, inputs, grads_wrt_outputs):
        ...
        """
<<<<<<< HEAD
        grads_wrt_weights = grads_wrt_outputs.T @ inputs
        grads_wrt_biases = np.sum(grads_wrt_outputs, axis=0).T
=======
